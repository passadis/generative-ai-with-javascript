...
**Ada Lovelace**: Στην πραγματικότητα, χρειαζόμαστε αυτή η συσκευή να λειτουργεί λίγο καλύτερα. Καμία ιδέα;

**Hedy Lamarr**: Σήκωσε τη συσκευή και την κοίταξε από διαφορετικές γωνίες. "Λες ότι έχετε ήδη διαχωρίσει τα features από το κομμάτι της επικοινωνίας;
